...
- `livewire-development` — Develops reactive Livewire 4 components. Activates when creating, updating, or modifying Livewire components; working with wire:model, wire:click, wire:loading, or any wire: directives; adding real-time updates, loading states, or reactivity; debugging component behavior; or when the user mentions Livewire, component, counter, or reactive UI.
...
# Laravel Rector Code Formatter

- You must run `vendor/bin/rector` before finalizing changes to ensure your code matches the project's expected style.
...
- Use the `search-docs` tool for official documentation on Artisan commands, code examples, relationships, and idiomatic practices.
